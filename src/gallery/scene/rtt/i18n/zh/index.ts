export default {
  ...
  fcr_device_option_choose_lang_content_1:'你修改教室的声源语言为“',
  ...
  fcr_dialog_rtt_subtitles_dialog_time_limit_reduce: '每个房间限时{reason1}分钟体验字幕和转写功能，剩余 {reason2} 分钟。',
  fcr_dialog_rtt_subtitles_dialog_time_limit_reduce_ellipsis: '剩余体验时间 {reason2} 分钟。',
  fcr_dialog_rtt_subtitles_dialog_time_limit_end: '每个房间限时{reason1}分钟体验字幕和转写功能，体验时间已用完。',
