export interface AgoraChatStatic {
	connection: typeof AgoraChat.Connection;
	message: typeof AgoraChat.Message;
	utils: AgoraChat.Utils;
	logger: AgoraChat.Logger;
	statusCode: AgoraChat.Code;
}
declare const agoraChat: AgoraChatStatic;
export default agoraChat;
export declare namespace AgoraChat {
